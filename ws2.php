...
// exit;
    ...
    foreach ($datos as $key => $value){  
        ...
        if ($value['tipo_formulario'] == 2 && $solounavez == 0)
        {
        ...
        /*switch ($value['tipo_formulario']) { // valida tipo formulario y asigna tabla y unique
            case 1:
                // $tbl = "cli_ant_cli";
                // $validador = "rut";
                break;
        ...
        if($value['tipo_formulario'] > 0 && is_numeric($value['tipo_formulario']) && $value[$validador][0] > -1) 
        {
            ...
            }else
            {
                ...
                if($value['tipo_formulario'] == 2){ $mat_ide = $value['mat_eje'][0];} // almacenamos ide para eliminacion
                if($value['tipo_formulario'] == 1){
                ...
                if($value['tipo_formulario'] == 1) // verificar si siempre se actualizar.
                {
                    ...
                    $select2 = "SELECT *
                    FROM cli_mat_pro
                    WHERE pro_rut = '".$value[$validador][0]."' AND flg_del = 0";
                    //$msg .= $select2;
                    ...
                    if ($row_sql2 = pg_fetch_assoc($rs_select2))
                    {
                        ...
                        /*$msg .= $usu_act. " === ".$pro_usu_ins_o;
                        $msg .= "<br>"; 
                        
                        $pro_usu_ins_o  = "aqui"; // cambiar
                        
                        $pro_tip        = "999"; // cambiar
                        $pro_eje_o      = "9999";// cambiar
                        */
                ...
                }elseif ($value['tipo_formulario'] == 2) {
